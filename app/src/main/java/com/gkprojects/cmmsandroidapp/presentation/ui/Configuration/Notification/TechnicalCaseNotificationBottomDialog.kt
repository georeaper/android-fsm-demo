...
import com.gkprojects.cmmsandroidapp.databinding.DialogFragmentNotificationTechnicalCaseBinding
...
class TechnicalCaseNotificationBottomDialog :
    BaseReminderBottomSheet<ReminderSettingsGeneric>() {

    private lateinit var binding: DialogFragmentNotificationTechnicalCaseBinding
    ...
    override fun onCreateView(
        ...
        binding = DialogFragmentNotificationTechnicalCaseBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        viewModel.getRemindersOnTechnicalCases()
...
//        recyclerview.layoutManager= LinearLayoutManager(requireContext())
    ...
    override fun saveSettings(settings: ReminderSettingsGeneric) {
        viewModel.saveTechnicalCasesReminders(settings)
    }
