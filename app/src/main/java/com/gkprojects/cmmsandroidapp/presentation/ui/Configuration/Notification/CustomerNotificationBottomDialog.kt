...
import com.gkprojects.cmmsandroidapp.databinding.DialogFragmentNotificationCustomerBinding
...
class CustomerNotificationBottomDialog :
    BaseReminderBottomSheet<ReminderSettingsGeneric>() {

    private lateinit var binding: DialogFragmentNotificationCustomerBinding
    ...
    override fun onCreateView(
        ...
        binding = DialogFragmentNotificationCustomerBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        viewModel.getRemindersOnCustomers()
...
//        recyclerview.layoutManager= LinearLayoutManager(requireContext())
    ...
    override fun saveSettings(settings: ReminderSettingsGeneric) {
        viewModel.saveCustomerReminders(settings)
    }
