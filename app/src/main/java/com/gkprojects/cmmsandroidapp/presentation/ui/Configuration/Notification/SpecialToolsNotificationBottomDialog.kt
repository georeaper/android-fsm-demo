...
import com.gkprojects.cmmsandroidapp.databinding.DialogFragmentNotificationSpecialToolsBinding
...
class SpecialToolsNotificationBottomDialog :
    BaseReminderBottomSheet<ReminderSettingsGeneric>() {

    private lateinit var binding: DialogFragmentNotificationSpecialToolsBinding
    ...
    override fun onCreateView(
        ...
        binding = DialogFragmentNotificationSpecialToolsBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        viewModel.getRemindersOnSpecialTools()
...
//        recyclerview.layoutManager= LinearLayoutManager(requireContext())
    ...
    override fun saveSettings(settings: ReminderSettingsGeneric) {
        viewModel.saveSpecialToolsReminders(settings)
    }
