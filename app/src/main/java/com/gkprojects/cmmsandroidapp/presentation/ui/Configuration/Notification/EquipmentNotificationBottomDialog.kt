...
import com.gkprojects.cmmsandroidapp.databinding.DialogFragmentNotificationEquipmentBinding
...
class EquipmentNotificationBottomDialog :
    BaseReminderBottomSheet<EquipmentReminderSettings>() {

    private lateinit var binding: DialogFragmentNotificationEquipmentBinding
    ...
    override fun onCreateView(
        ...
        binding = DialogFragmentNotificationEquipmentBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        viewModel.getRemindersOnEquipments()
...
//        recyclerview.layoutManager= LinearLayoutManager(requireContext())
    ...
    override fun decodeSettings(json: String) =
        Json.decodeFromString<EquipmentReminderSettings>(json)

    override fun encodeSettings() =
        EquipmentReminderSettings(
    ...
    override fun onSettingsLoaded(settings: EquipmentReminderSettings) {
        reminders.clear()
    ...
    override fun saveSettings(settings: EquipmentReminderSettings) {
        viewModel.addOrUpdateEquipmentReminders(settings)
    }
}