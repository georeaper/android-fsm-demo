...
import com.gkprojects.cmmsandroidapp.databinding.DialogFragmentNotificationTasksBinding
...
class TasksNotificationBottomDialog :
    BaseReminderBottomSheet<ReminderSettingsGeneric>() {

    private lateinit var binding: DialogFragmentNotificationTasksBinding
    ...
    override fun onCreateView(
        ...
        binding = DialogFragmentNotificationTasksBinding.inflate(inflater, container, false)
...
//        recyclerview.layoutManager= LinearLayoutManager(requireContext())
    ...
    override fun saveSettings(settings: ReminderSettingsGeneric) {
        viewModel.saveTasksReminders(settings)
    }
