...
class ContractTypeConf : Fragment() {
    ...
    private var contractTypeList = ArrayList<Settings>()
    ...
    private val settingKey ="ContractType"
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        rvAdapter = CustomizedFieldUniversalRVA(
            ...
            val color = try {
                Color.parseColor(setting.SettingsStyle ?: "")
